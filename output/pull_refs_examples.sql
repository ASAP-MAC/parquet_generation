...
CREATE OR REPLACE TABLE genefamilies_distinct AS 
    ...
    FROM '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/genefamilies_uuid.parquet'
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/gene_family_ref.parquet';

-- HUMAnN: pathway

CREATE OR REPLACE TABLE pathways_distinct AS 
    SELECT DISTINCT pathway
    FROM '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/pathabundance_uuid.parquet'
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/pathway_ref.parquet';

-- MetaPhlAn: clade_name

CREATE OR REPLACE TABLE clade_names_distinct AS 
    SELECT DISTINCT clade_name, NCBI_tax_id
    FROM '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/relative_abundance_uuid.parquet'
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/clade_name_ref.parquet';

-- MetaPhlAn: genome_name

CREATE OR REPLACE TABLE genome_names_distinct AS 
    SELECT DISTINCT genome_name
    FROM '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/viral_clusters_uuid.parquet'
    ORDER BY genome_name ASC;

COPY
    (SELECT * FROM genome_names_distinct)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/genome_name_ref.parquet';

-- MetaPhlAn: uniref_marker

CREATE OR REPLACE TABLE uniref_markers_distinct AS 
    SELECT DISTINCT uniref
    FROM '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/marker_abundance_uuid.parquet'
    ORDER BY uniref ASC;

COPY
    (SELECT * FROM uniref_markers_distinct)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/uniref_marker_ref.parquet';