-- Usage: duckdb goose.duckdb < Mat5b_metaphlan.sql
install httpfs;
load httpfs;
...
SET VARIABLE sample_ids = list_value(
        'fe578ef4-d87b-4e3a-b295-eaf5478f07be',
        '07248d77-a19a-4e38-a478-7f5444256553',
        '1e0d35f8-fc71-47ff-ad54-5ff6010af23e',
        '764ffcf0-256d-4d4d-816e-9dec39deb392',
        'dec1dd17-0e3b-41c8-afcb-ef76034d0ede',
        '31c39f82-edc3-4d50-a3ff-fffb4501a787',
        '3d4ff822-01ac-468a-8909-0852029b9b55',
        '4afb402e-c54c-4c29-9d9e-d5e3c660ae7b',
        'bfb24662-4fbb-426a-a6dc-83cc83ff27ac',
        '0ae04ca1-09ab-414c-91b3-a9d8d2fe7d23');
