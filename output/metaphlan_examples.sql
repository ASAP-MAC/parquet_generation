...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/relative_abundance_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM relative_abundance_joined ORDER BY clade_name_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/relative_abundance_clade_name_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/viral_clusters_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM viral_clusters_joined ORDER BY genome_name ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/viral_clusters_genome_name.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/marker_abundance_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM marker_abundance_joined ORDER BY uniref ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/marker_abundance_uniref.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/marker_presence_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM marker_presence_joined ORDER BY uniref ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/marker_presence_uniref.parquet'
    (format parquet, compression 'zstd');
