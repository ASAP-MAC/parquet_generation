-- Usage: duckdb goose.duckdb < humann_examples.sql
install httpfs;
load httpfs;
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_cpm_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_cpm_stratified_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_stratified_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_cpm_unstratified_joined ORDER BY gene_family ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_cpm_unstratified_gene_family.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_relab_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_relab_stratified_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_stratified_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_relab_unstratified_joined ORDER BY gene_family ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_relab_unstratified_gene_family.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_stratified_joined ORDER BY gene_family_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_stratified_gene_family_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM genefamilies_unstratified_joined ORDER BY gene_family ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/genefamilies_unstratified_gene_family.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_cpm_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_relab_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_stratified_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_stratified_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_unstratified_joined ORDER BY pathway ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_unstratified_pathway.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_cpm_stratified_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_stratified_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_relab_stratified_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_stratified_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_cpm_unstratified_joined ORDER BY pathway ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_cpm_unstratified_pathway.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathabundance_relab_unstratified_joined ORDER BY pathway ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathabundance_relab_unstratified_pathway.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathcoverage_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_stratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathcoverage_stratified_joined ORDER BY pathway_species ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_stratified_pathway_species.parquet'
    (format parquet, compression 'zstd');
...
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_unstratified_uuid.parquet'
    (format parquet, compression 'zstd');

COPY
    (SELECT * FROM pathcoverage_unstratified_joined ORDER BY pathway ASC)
TO '/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/examples/pathcoverage_unstratified_pathway.parquet'
    (format parquet, compression 'zstd');
