...
# Load config
with open("config/resort_configs.yaml") as f:
...
basic_template = env.get_template("resort_template.sql.j2")
...
mem_limit = "200GB"
threads = "6"
infile_prefix = "/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/"
outfile_prefix = "/shares/CIBIO-Storage/CM/scratch/users/kaelyn.long/retrieve/parquets/metagenomics_mac_examples/"
